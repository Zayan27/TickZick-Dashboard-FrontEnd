...
const CustomizerWrap = Styled.div`
    ...
    .tickzick-customizer{
        ...
        .tickzick-customizer__head{
            ...
            .tickzick-customizer__title{
                font-weight: 600;
                color: ${({ theme }) => theme[theme.mainContent]['dark-text']};
                font-size: 16px;
                margin-bottom: 2px;
            }
            tickzick-customizer__sub-title{
                color: ${({ theme }) => theme[theme.mainContent]['gray-text']};
            }
        }
        .tickzick-customizer__body{
            padding: 25px;
        }
        .tickzick-customizer__single{
            &:not(:last-child){
                margin-bottom: 35px;
            }
            h4{
    ...
    .tickzick-customizer-list{
        margin: -10px;
        .tickzick-customizer-list__item{
            position: relative;
