...
const KnowledgebaseTopWrap = Styled.div`
    .custom-knowledgebadge-search-form{
        ...
        .tickzick-knowledgetop__formInner{
            .ant-form-item{
                margin-bottom: 0;
                @media only screen and (max-width: 575px){
                    width: 100%;
  ...
  theme[theme.mainContent]['border-color-secondary']};
    ...
    .tickzick-knowledgetop__popular--topics{
        margin-top: 22px;
        ul{
            display: flex;
            flex-wrap: wrap;
...
const CalendarWrapperPage = Styled.div`
    .tickzick-calendar-with-head{
      .react-calendar{
        padding: 0;
        margin-bottom: 0;
      }
    }
    .tickzick-calendar-wrap{
      .react-calendar{
...
const ProjectHeader = Styled.div`
    ...
    .ant-page-header.tickzick-page-header-main{
...
const TaskListStyle = Styled.div`
    .tickzick-tassklist-wrap{
        background-color: ${({ theme }) => theme[theme.mainContent]['white-background']};
        border-radius: 10px;
        min-height: 220px;
    }
    .tickzick-tasklist-head{
        .tickzick-tasklist-head__title{
            font-size: 16px;
            font-weight: 500;
            padding: 15px 30px;
            margin-bottom: 0;
    ...
    .tickzick-tasklist-body{
        .tickzick-tasklist{
            .tickzick-tasklist-item{
                display: flex;
                align-items: center;
                justify-content: space-between;
                padding: 7.5px 0;
                ...
                .tickzick-tasklist-item__content{
                    margin-right: 10px;
                }
            }
            .tickzick-tasklist-item__title{
                font-size: 16px;
                color: ${({ theme }) => theme[theme.mainContent]['dark-text']};
                .ant-checkbox + span{
                    position: relative;
            ...
            .tickzick-tasklist-item__action{
                display: flex;
                align-items: center;
                justify-content: center;
                min-width: 20px;
