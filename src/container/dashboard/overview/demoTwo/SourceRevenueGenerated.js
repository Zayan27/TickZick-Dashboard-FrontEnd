...
const SourceRevenueGenerated = React.memo(() => {
  ...
  const chartjsPieChart = {
    ...
    datasets: [
      {
        data: [1540, 1540, 5346],
        backgroundColor: ['#00AAFF', '#6DBE45', '#5840FF'],
      },
    ],
    scales: {
      x: {
  ...
  return (
    <GlobalUtilityStyle className="h-full">
      <Cards
        ...
        more={moreContent}
      >
        <div className="tickzick-chart-container flex items-center justify-between flex-wrap gap-y-[20px] py-[20px] sm:pt-0 px-[25px] 3xl:justify-center lg:justify-start md:justify-center gap-x-[20px] [&>.chartjs-tooltip>table>tbody>tr>td]:text-dark dark:[&>.chartjs-tooltip>table>tbody>tr>td]:text-white60">
