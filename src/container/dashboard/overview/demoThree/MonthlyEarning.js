  ...
  const earningsData = earnings !== null && [
    {
      ...
      fill: true,
      backgroundColor: () =>
        chartLinearGradient(document.getElementById('tickzick-earning-revenue'), 300, {
          start: '#6DBE4540',
          end: '#ffffff05',
        }),
    ...
    <>
      {earningsData !== null && (
        <div className="bg-white dark:bg-white10 m-0 p-0 text-theme-gray dark:text-white60 text-[15px] rounded-10 relative h-full">
          ...
          <div className="tickzick-chart-container px-[25px] pb-[25px]">
            <DashboardChart
              id="tickzick-earning-revenue"
