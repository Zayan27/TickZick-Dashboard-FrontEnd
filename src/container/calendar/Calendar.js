...
function Calendars() {
  ...
  return (
    <>
      ...
      />
      <CalendarWrapperPage>
        <div className="min-h-[715px] lg:min-h-[580px] px-8 xl:px-[15px] pb-[30px] bg-transparent tickzick-calendar-wrap">
          <Row gutter={25}>
            ...
            <Col xxl={18} xl={15} xs={24}>
              ...
              <Modal
                ...
                className={`tickzick-event-form-modal [&>div>.ant-modal-header]:bg-current [&>div>.ant-modal-header]:text-current [&>div>.ant-modal-header]:rounded-t-10 [&>.ant-modal-content]:rounded-10 [&>div>.ant-modal-header]:py-[19px] [&>div>.ant-modal-header>.ant-modal-title]:text-white dark:[&>div>.ant-modal-header>.ant-modal-title]:text-white87 text-${selectedEvent.label}`}
              ...
              >
                <div className="relative">
                  ...
                  <div className="tickzick-event-details">
                    <ul className="mb-[4px]">
                      <li className="flex items-center text-[14px] mb-[6px]">
                        ...
                        <span className="tickzick-event-text text-[14px] font-medium text-dark dark:text-white87">
                          <span>
