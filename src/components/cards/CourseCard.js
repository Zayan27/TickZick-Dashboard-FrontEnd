      ...
      <div className="mb-[25px] [&>.ant-card>.ant-card-body]:p-[18px]">
        <Card bordered="false">
          <div className="mb-[15px] rounded-[10px]">
            <img className="3xl:w-full" src={require(`../../static/img/courses/${thumbnail}`)} alt="tickzick" />
          </div>
          <div>
            ...
            <div className="flex items-center gap-2.5 mb-5">
              <img className="w-[30px]" src={require(`../../static/img/avatar/${authorImg}`)} alt="tickzick" />
